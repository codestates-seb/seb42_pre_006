            ...
            <ul className="flex justify-around px-3">
                <li className="w-1/4 border text-sm p-4 mb-2 mr-2">
                    ...
                    <p className="mt-5 truncate">
                        ...
                        (JavaScript/JS) and its different
                        dialects/implementations (except for ActionScript). Keep
                        in mind that JavaScript is NOT the same as Java! Include
                        all labels that are relevant to your question; e.g.,
                        [node.js], [jQuery], [JSON], [ReactJS], [angular],
