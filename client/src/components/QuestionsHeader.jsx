    ...
    return (
        <section>
            <div className="flex content-center justify-between mx-8 my-8">
                ...
                <button className="text-xs bg-[#0A95FF] hover:bg-[#0074CC] text-white font-semibold py-2.5 px-3 border-t-2 border-[#47aefd] hover:border-[#47aefd] rounded">
                    Ask Question
                </button>
            </div>
            ...
            <div className=" flex content-center justify-between mx-8 my-3">
                ...
                <div className=" border border-[#6a737c] rounded text-xs">
                    <button className="bg-[#e3e6e8] text-[#3b4045] py-2 px-2  rounded-l border-r border-[#6a737c]">
                        Newest
                    </button>
                    <button className="text-[#6a737c] py-2 px-2 border-r border-[#6a737c]  hover:bg-[#edeff1]">
                        Active
                    </button>
                    <button className="text-[#6a737c] py-2 px-2 border-r border-[#6a737c] hover:bg-[#edeff1]">
                        Bountied
                    ...
                    <button className="text-[#6a737c] py-2 px-2 hover:bg-[#edeff1]">
                        More
